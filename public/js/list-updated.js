...
const createCard = item => {
    ...
    titleLink.classList.add('stretched-link', 'text-decoration-none', 'link-dark', 'springItemCardLink');
    ...
    likeBtn.classList.add('spring-heart-wrap', 'btn', 'p-1', 'border-0', 'rounded-3', 'btn-outline-light', 'springItemCardHeart');
